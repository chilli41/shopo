...
- (nonnull instancetype)init:(NSInteger)value alpha:(CGFloat)alpha;
...
- (UIColor * _Nonnull)alpha:(CGFloat)value;
...
- (UIColor * _Nonnull)mixWithColor:(UIColor * _Nonnull)color amount:(float)amount;
@end
